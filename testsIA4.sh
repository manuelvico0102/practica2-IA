...
echo "Mapa: ./mapas/mapa75.map------------------------" >> $output.dat
...
echo "Mapa: ./mapas/mapa100.map------------------------" >> $output.dat
...
echo "Mapa: ./mapas/pinkworld.map------------------------" >> $output.dat
...
echo "Mapa: ./mapas/islas.map------------------------" >> $output.dat
...
echo "Mapa: ./mapas/marymonte.map------------------------" >> $output.dat
...
echo "Mapa: ./mapas/medieval.map------------------------" >> $output.dat
